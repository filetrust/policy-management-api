...
namespace PolicyManagement.Business.Tests.Store.AzureFileShareTests.ListAsync
{
    [TestFixture]
    public class WhenRecursingDirectoryAndActionIsContinue : AzureFileShareTestBase
    {
        ...
        public async Task Setup()
        {
            ...
            pathActionSequence.Returns(PathAction.Break);
            ...
            for (var i = NumberOfDirectoriesInTree; i < _directories.Length; i++)
            {
                ...
                foreach (var subItem in items)
                    pathActionSequence.Returns(PathAction.Continue);
            }
        ...
        [Test]
        public void Only_Top_Level_Is_Checked()
        {
        ...
        public void Each_Directory_Action_Is_Decided()
        {
            ...
            _input.Verify(s => s.DecideAction(It.IsAny<string>()), Times.Once);
